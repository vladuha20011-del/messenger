        ...
        async with conn.cursor() as cur:
            ...
            await cur.execute("""
                CREATE TABLE IF NOT EXISTS users (
                    ...
                    has_active_warning BOOLEAN DEFAULT 0,
            ...
            if count == 0:
                ...
                await cur.execute("""
                    INSERT INTO users (username, display_name, password_hash, role, is_verified, created_at, account_status)
                    VALUES (%s, %s, %s, %s, %s, %s, %s)
                """, ('arm', 'arm', password_hash, 'owner', 1, datetime.now(), 'active'))
                print("➕ Создан тестовый пользователь: arm / 123")
    ...
    try:
        ...
        async with db_pool.acquire() as conn:
            async with conn.cursor() as cur:
                ...
                # Отправляем обновление всем активным пользователям
